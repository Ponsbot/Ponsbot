...
const launchDetails = [
  ...
  { title: "Buy back and burn your token", body: "Choose a percentage of your creator-fee share to automatically buy back and burn your token. Add “assign 50% of fees to buyback and burn” to the launch, or change the percentage later as the current fee owner. Assigning fees to another recipient or sharing them with holders is a separate choice." },
];
