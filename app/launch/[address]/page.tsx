...
export default async function LaunchPage({ params }: Props) {
  ...
  return <main><SiteHeader /><section className="detail-shell"><TokenActivity tokenAddress={launch.tokenAddress} symbol={launch.symbol} artwork={artwork} summary={summary} details={details} /></section><SiteFooter /></main>;
}
