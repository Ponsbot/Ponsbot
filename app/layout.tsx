...
.launch-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin-top:18px}.launch-card{min-width:0;padding:8px;border:1px solid #dcded2;border-radius:14px;background:#fffdf7;display:flex;flex-direction:column}.launch-card-footer{margin-top:auto}.token-art{position:relative;display:grid;place-items:center;aspect-ratio:1;overflow:hidden;border-radius:9px;background:#e8edda}.token-art img{width:100%;height:100%;object-fit:cover}
