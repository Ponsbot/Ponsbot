  ...
  return <main>
    ...
    <section className="home-hero">
      <div className="hero-copy">
        <h1><span style={{ display: "block", whiteSpace: "nowrap" }}>Your <span style={{ color: "var(--green)" }}>everything</span></span><span style={{ display: "block", whiteSpace: "nowrap" }}>bot on <span style={{ color: "var(--green)" }}>Robinhood.</span></span></h1>
