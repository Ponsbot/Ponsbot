...
export function BotYardScene() {
  return <svg className={styles.scenery} viewBox="0 0 1000 600" preserveAspectRatio="none" aria-hidden="true">
    <defs>
      <pattern id="yard-soil" width="14" height="14" patternUnits="userSpaceOnUse"><rect width="14" height="14" fill="#a87751"/><path d="M2 10h7" stroke="#8b5d40" strokeWidth="2"/></pattern>
    </defs>
    ...
    <g transform="translate(160 403)">
      <ellipse cx="0" cy="38" rx="75" ry="14" fill="#698957" opacity=".2"/>
      <rect x="-64" y="-24" width="128" height="61" rx="6" fill="url(#yard-soil)" stroke="#805b3d" strokeWidth="7"/>
