...
export function SiteHeader() {
  return <header className="site-header">
    ...
    <div className="header-ca" aria-label="Ponsbot contract address placeholder">$PONSBOT: XXXXXXXXXXXXXXXXXXXXXXX</div>
...
export function SiteFooter() {
  return <footer className="site-footer">
    <div><Link href="/" className="wordmark"><Image className="brand-logo" src="/ponsbot.png" alt="" width={42} height={42} /><span>Ponsbot</span></Link><p>Wallet and launch tools for Robinhood Chain, direct on X.</p></div>
