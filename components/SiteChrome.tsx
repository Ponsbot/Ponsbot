...
import { VotesNavLink } from "@/components/VotesNavLink";
...
export function SiteHeader() {
  return <header className="site-header">
    ...
    <nav>{tradingAgentCapabilities().website && <><Link href="/bot-yard">BOT YARD</Link><MyBotLink /></>}<VotesNavLink /><Link href="/stats">STATS</Link><Link href="/terminal">TERMINAL</Link><Link href="/how-it-works">HOW IT WORKS</Link><Link href="/#launches">LAUNCHES</Link><a className="x-nav-link" href="https://x.com/Ponsbotfamily" target="_blank" rel="noreferrer" aria-label="Ponsbotfamily on X"><Image src="/x-logo.png" alt="" width={20} height={20} /></a><a className="tg-nav-link" href="https://t.me/The_Pons_Bot" target="_blank" rel="noreferrer" aria-label="Pons Bot on Telegram"><Image src="/telegram-logo.png" alt="" width={20} height={20} /></a><WalletAccountMenu /></nav><MobileNav botYard={tradingAgentCapabilities().website} />
  </header>;
}
