...
export function SiteFooter() {
  return <footer className="site-footer">
    ...
    <div><strong>Explore</strong><Link href="/how-it-works">How it works</Link><Link href="/#launches">Launches</Link><Link href="/votes">Voting</Link><a href="https://x.com/Ponsbotfamily" target="_blank" rel="noreferrer">@ponsbotfamily</a></div>
