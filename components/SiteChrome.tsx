...
export function SiteFooter() {
  return <footer className="site-footer">
    ...
    <div className="footer-legal"><strong>Legal</strong><nav aria-label="Legal"><Link href="/privacy">Privacy Policy</Link><Link href="/terms">Terms of Use</Link><Link href="/risk">Risk Disclaimer</Link></nav><p>Blockchain transactions may be irreversible. Tokens and liquidity positions can be volatile or lose all value. Pons Bot provides no warranties or financial advice.</p><a href="mailto:ponsbot@ponsbot.family">ponsbot@ponsbot.family</a></div>
  </footer>;
}
