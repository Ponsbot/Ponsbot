...
export function walletHelpMessage(topic: WalletHelpTopic) {
  const messages: Record<WalletHelpTopic, string> = {
    ...
    launch: "🚀 Verified X accounts can launch on Pons V2 from an X post! Add a name and ticker, plus optional artwork, description, website, X, and TG links, dev buy, or paired asset.",
