...
const scenarios: Scenario[] = [
  ...
  { post: "claim the PONSBOT launch fees", expected: { kind: "command", operation: "claim_fees", fields: { token: "PONSBOT" } } },
  { post: "withdraw creator rewards for $PONSBOT", expected: { kind: "command", operation: "claim_fees", fields: { token: "PONSBOT" } } },
  ...
  { post: "buy 5 MSFT of PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "5", unit: "pair", token: "PONSBOT", pairAsset: "MSFT" } } },
  { post: "use 2.75 SNDK to purchase $PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "2.75", unit: "pair", token: "PONSBOT", pairAsset: "SNDK" } } },
  { post: "put ten MSFT into PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "10", unit: "pair", token: "PONSBOT", pairAsset: "MSFT" } } },
  { post: "buy $100 of PONSBOT even though it is paired with MSFT", expected: { kind: "command", operation: "buy", fields: { amount: "100", unit: "usd", token: "PONSBOT" } } },
  { post: "buy 5 TSLA of PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "5", unit: "pair", token: "PONSBOT", pairAsset: "TSLA" } } },
  ...
  { post: "claim my fees and then buy PONSBOT", expected: { kind: "unknown_wallet" } },
  { post: "I claimed PONSBOT fees yesterday", expected: { kind: "irrelevant" } },
  ...
  { post: "@Ponsbotfamily buy $100 of $PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "100", unit: "usd", token: "PONSBOT" } } },
  { post: "buy 0.03 ETH worth of PONSBOT please", expected: { kind: "command", operation: "buy", fields: { amount: "0.03", unit: "eth", token: "PONSBOT" } } },
  { post: "spend $42 on PONSBOT even if its pair is MSFT", expected: { kind: "command", operation: "buy", fields: { amount: "42", unit: "usd", token: "PONSBOT" } } },
  { post: "use 0.015 ETH to buy the MSFT-paired PONSBOT token", expected: { kind: "command", operation: "buy", fields: { amount: "0.015", unit: "eth", token: "PONSBOT" } } },
  { post: "grab me twenty five dollars of PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "25", unit: "usd", token: "PONSBOT" } } },
  { post: "buy 3.5 MSFT of PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "3.5", unit: "pair", token: "PONSBOT", pairAsset: "MSFT" } } },
  { post: "put 8 SNDK into $PONSBOT", expected: { kind: "command", operation: "buy", fields: { amount: "8", unit: "pair", token: "PONSBOT", pairAsset: "SNDK" } } },
  { post: "buy $60 of PONSBOT and send it to @alice", expected: { kind: "command", operation: "buy_and_send", fields: { amount: "60", unit: "usd", token: "PONSBOT", recipient: "@alice" } } },
  { post: "buy $25 of PONSBOT and burn it", expected: { kind: "command", operation: "buy_and_burn", fields: { amount: "25", unit: "usd", token: "PONSBOT" } } },
  { post: "burn the PONSBOT tokens I buy with 0.01 ETH", expected: { kind: "command", operation: "buy_and_burn", fields: { amount: "0.01", unit: "eth", token: "PONSBOT" } } },
  { post: "buy 5 MSFT of PONSBOT, then burn everything from that purchase", expected: { kind: "command", operation: "buy_and_burn", fields: { amount: "5", unit: "pair", token: "PONSBOT", pairAsset: "MSFT" } } },
  { post: "purchase $25 of PONSBOT and burn it", expected: { kind: "unknown_wallet" } },
  { post: "buy $25 of PONSBOT and destroy it", expected: { kind: "unknown_wallet" } },
  { post: "buy 0.01 ETH of PONSBOT then send the purchased tokens to 0x1111111111111111111111111111111111111111", expected: { kind: "command", operation: "buy_and_send", fields: { amount: "0.01", unit: "eth", token: "PONSBOT", recipient: "0x1111111111111111111111111111111111111111" } } },
  { post: "launch Ponsbot ticker PONSBOT pair with MSFT dev buy $100", expected: { kind: "command", operation: "launch", fields: { name: "Ponsbot", symbol: "PONSBOT", pairToken: "MSFT", devBuy: { amount: "100", unit: "usd" } } } },
  { post: "launch Ponsbot ticker $PONSBOT paired with SNDK and dev buy 0.02 ETH", expected: { kind: "command", operation: "launch", fields: { name: "Ponsbot", symbol: "PONSBOT", pairToken: "SNDK", devBuy: { amount: "0.02", unit: "eth" } } } },
  { post: "deploy Ponsbot ticker PONSBOT against MSFT with a 4 MSFT developer buy", expected: { kind: "command", operation: "launch", fields: { name: "Ponsbot", symbol: "PONSBOT", pairToken: "MSFT", devBuy: { amount: "4", unit: "pair" } } } },
  { post: "Launch Ponsbot $PONSBOT, pair asset TSLA, dev buy $75, website ponsbot.family", expected: { kind: "command", operation: "launch", fields: { name: "Ponsbot", symbol: "PONSBOT", pairToken: "TSLA", website: "https://ponsbot.family", devBuy: { amount: "75", unit: "usd" } } } },
  ...
  { post: "what happens between my dollar buy and the PONSBOT purchase?", expected: { kind: "help", topic: "buy_sell" } },
  { post: "buy PONSBOT with ETH", expected: { kind: "unknown_wallet" } },
  { post: "launch Ponsbot ticker PONSBOT pair MSFT dev buy", expected: { kind: "command", operation: "launch", fields: { name: "Ponsbot", symbol: "PONSBOT", pairToken: "MSFT" } } },
  { post: "buy $50 of PONSBOT with MSFT", expected: { kind: "command", operation: "buy", fields: { amount: "50", unit: "usd", token: "PONSBOT" } } },
  { post: "buy $50 of PONSBOT and sell it right away", expected: { kind: "unknown_wallet" } },
  { post: "swap $25 into MSFT and launch Ponsbot ticker PONSBOT", expected: { kind: "unknown_wallet" } },
  { post: "claim fees", expected: { kind: "command", operation: "claim_fees" } },
  ...
  { post: "claim my PONSBOT fees and buy $10 more PONSBOT", expected: { kind: "unknown_wallet" } },
];
