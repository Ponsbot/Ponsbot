...
const examples: Example[] = [
  ...
  ...cases("buy", [
    ...
    "grab me ten bucks of $POTATO @Ponsbotfamily", "@Ponsbotfamily buy TEST with 0.01 ETH",
    ...
    "Trying this from my phone, hope syntax doesn't matter: @Ponsbotfamily get me ten dollars worth of POTATO",
    "This is the CA I mean, not the ticker: 0xA010000000000000000000000000000000000245 — @Ponsbotfamily buy $15",
  ]),
  ...cases("sell", [
    "@Ponsbotfamily sell 10 $SNDK", "sell half of SNDK @Ponsbotfamily", "@Ponsbotfamily dump 25% of $POTATO",
    "@Ponsbotfamily liquidate my entire TEST position", "@Ponsbotfamily unload 75 percent of SNDK",
    "sell three quarters of my $DAY @Ponsbotfamily", "@Ponsbotfamily sell 1/2 my POTATO",
    ...
    "Taking initials out and letting the rest ride. @Ponsbotfamily sell a quarter of my POTATO",
    "Taking 25% off this one: 0xB003000000000000000000000000000000000263 @Ponsbotfamily sell 25%",
  ]),
  ...cases("send", [
    "@Ponsbotfamily send 10 SNDK to @alice", "@Ponsbotfamily give @bob five $POTATO",
    "send @charlie 0.01 ETH @Ponsbotfamily", "@Ponsbotfamily transfer half my DAY to @dave",
    "@Ponsbotfamily send @erin 25% of SNDK", "@Ponsbotfamily move all my POTATO to @george",
  ...
  ...cases("launch", [
    "@Ponsbotfamily launch Potato Party ticker $POTATO", "launch Daybreak DAY @Ponsbotfamily",
