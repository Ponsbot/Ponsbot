...
const examples: Example[] = [
  ...
  ...commands("launch", [
    "@Ponsbotfamily launch Daybreak ticker $DAY", "Launch Harbor ticker $HARBOR @Ponsbotfamily",
    "@Ponsbotfamily create a token called Moon Rock ticker $ROCK", "@Ponsbotfamily launch Night Shift $NIGHT",
    "make me a token named Terminal Harbor ticker $PORT @Ponsbotfamily", "@Ponsbotfamily deploy Brightside ticker BRIGHT",
    ...
    "Launch Harbor Club $HARBOR, description \"built onchain\", website harborclub.xyz @Ponsbotfamily",
  ...
  { post: "Create Harbor Protocol $HARBOR, pair with ETH, developer buy 0.1 ETH @Ponsbotfamily", operation: "launch" },
  ...
  { post: "@Ponsbotfamily what's my wallet and buy $10 SNDK then send half of it to @friend and launch Harbor ticker $HARBOR", kind: "unknown_wallet" },
